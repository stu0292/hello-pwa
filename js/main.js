...
// make epub
document.querySelector('#makeEpub').addEventListener('click', e => {
  e.preventDefault();
  ...
  jepub.notes('<p class="no-indent">Dịch sang Tiếng Việt bởi <strong>Đỗ Việt</strong> - www.doviet.net</p>');
